...
export function A2UIViewer({
  ...
  const handleAction: OnActionCallback | undefined = useMemo(() => {
    ...
    return (message: Types.A2UIClientEventMessage) => {
      ...
      if (userAction) {
        const legacySourceComponentId =
          'sourceComponentId' in userAction ? userAction.sourceComponentId : undefined;
        const sourceComponentId =
          userAction.source?.componentId ?? legacySourceComponentId;
        onAction({
