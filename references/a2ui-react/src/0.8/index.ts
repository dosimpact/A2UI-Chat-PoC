 ...
 *
 * This is the versioned entry point maintainers should read first when tracing
 * the public surface area of the library. It exposes the provider/renderer
 * pair, the hooks used by custom middleware, and the core types that downstream
