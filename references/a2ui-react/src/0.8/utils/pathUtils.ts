/**
 * Low-level path manipulation helpers for the per-surface data model.
 *
 * Most runtime state changes eventually pass through these helpers. If a bound
 * value is not updating as expected, this file is part of the shortest debug
 * path.
 */
