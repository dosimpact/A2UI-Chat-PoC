/**
 * Core value-resolution helpers used across the runtime.
 *
 * This file is where the protocol's abstract values become concrete React
 * inputs: literal values stay as-is, path references are resolved against a
 * surface-local data model, and server payload fragments are normalized into
 * plain objects that contexts can store.
 */
